    ...
    <div>
      <div className="flex items-end justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-0.5">{logsData?.total ?? "—"} entries</p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-100">
                ...
                <th className="px-5 py-3 text-left label-meta">{t.colArticles}</th>
                <th className="px-5 py-3 text-left label-meta">{t.colMessage}</th>
